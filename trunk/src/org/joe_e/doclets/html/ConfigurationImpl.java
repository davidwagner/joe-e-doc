/*
 * @(#)ConfigurationImpl.java	1.59 03/09/17
 *
...
import org.joe_e.doclets.JoeEDocConsumer;
...
public class ConfigurationImpl extends Configuration {
    ...
    /**
     * Argument for command line option "-safejpath".
     */
    public String safejpath = "";
    ...
    /**
     * The JoeEConsumer required to get all the extra data
     * from the safej files
     */
    public JoeEDocConsumer consumer;
    ...
    public int optionLength(String option) {
        ...
        if (option.equals("-nodeprecatedlist") ||
            ...
            return 1;
        } else if (option.equals("-safejpath")||
