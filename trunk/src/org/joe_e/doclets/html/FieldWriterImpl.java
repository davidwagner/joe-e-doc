...
public class FieldWriterImpl extends AbstractMemberWriter 
    ...
    public void writeComments(FieldDoc field) {
        ...
        String className = holder.qualifiedName();
        MemberInfo m = writer.configuration.consumer.getInfo(field);
        ...
        if (m == null) {
            ...
            if (writer.configuration.consumer.isDisabled(className)) {
                ...
                System.err.println("WARNING: no policy for " + className + "." + field.name());
